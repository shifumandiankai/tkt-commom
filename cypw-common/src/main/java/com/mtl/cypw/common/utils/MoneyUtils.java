...
import com.mtl.cypw.common.enums.CurrencyEnum;
...
public class MoneyUtils {
    ...
    public static long round(double cent) {
        return round(cent, CurrencyEnum.CNY);
    }
    ...
    public static Money calcaluteMoneyByRatio(Long cent, Double ratio) {
        ...
        return MoneyUtils.getMoneyByCent(MoneyUtils.round(MoneyUtils.getMoneyByCent(cent).multiply(ratio).getCent(), 0));
    }

    public static Money calcaluteMoneyByRatioInCent(Long cent, BigDecimal ratio) {
        if (cent == null) {
            return null;
        }
        ...
        return MoneyUtils.getMoneyByCent(MoneyUtils.round(MoneyUtils.getMoneyByCent(cent).multiply(ratio).getCent(), 2));
    }

    public static Money getMoneyRoundInCent(Money money) {
        return money == null ? null : getMoneyRoundInCent(money.getCent());
    }

    public static Money getMoneyRoundInCent(Long cent) {
        if (cent == null) {
            return null;
        }
        return MoneyUtils.getMoneyByCent(MoneyUtils.round(cent, 2));
    }
}
